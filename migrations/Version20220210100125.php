 ...
 */
final class Version20220210100125 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD is_guard_check_ip TINYINT(1) NOT NULL, ADD whitelisted_ipaddresses JSON NOT NULL');
    }
